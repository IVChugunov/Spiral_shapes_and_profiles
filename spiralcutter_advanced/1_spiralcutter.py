...
if __name__ == '__main__':
    ...
    parser.add_argument("--name_img", help="Name of image file", default="spirals.fits")
    parser.add_argument("--fit", help="Name of fitted imfit file", default="fit_nosp.imfit")
    parser.add_argument("--dots_reg", help="Name of ds9 region region file containing marked spirals", default="dots.reg")
    parser.add_argument("--mask", help="mask name", default="mask.fits")
    parser.add_argument("--psf", help="PSF image; leave None to not use PSF", default="psf.fits")

    args = parser.parse_args()

    spiralcutter(args.name_img, args.fit, args.dots_reg,
        args.mask, args.psf)